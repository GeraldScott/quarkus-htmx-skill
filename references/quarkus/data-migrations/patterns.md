...
- `./configuration section in api.md` - Property combinations used by these workflows
- `./gotchas.md` - Safety limits around baseline, clean, validation, and reactive access
