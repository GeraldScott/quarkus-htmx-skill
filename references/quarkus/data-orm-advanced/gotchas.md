...
- `../dependency-injection/` - CDI lookup and producer patterns for inactive beans
- `../data-migrations/` - Schema ownership when multitenancy disables normal ORM generation
